...
MODELS = {
    ...
    'llava_ov_7b': {
        ...
        'model_path': '/home/work/Redteaming/kyuho/strm/rekv_analysis/model_zoo/llava-onevision-qwen2-7b-ov-hf/snapshots/0d50680527681998e456c7b78950205bedd8a068',
    },
    'llava_ov_72b': {
        'load_func': llava_onevision_rekv.load_model,
        'model_class': LlavaOnevisionForConditionalGeneration,
...
def work(QA_CLASS):
    ...
    # FIXME: remove later: 여기서 QA_CLASS는 ReKVStreamVQA 또는 ReKVOfflineVQA 중 하나
